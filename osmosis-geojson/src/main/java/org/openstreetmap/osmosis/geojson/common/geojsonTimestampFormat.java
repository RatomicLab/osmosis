...
/**
 * A timestamp format implementation for dates read and stored from osm geojson
 * files.
 *
 * @author Brett Henderson
 */
public class geojsonTimestampFormat extends TimestampFormat {
