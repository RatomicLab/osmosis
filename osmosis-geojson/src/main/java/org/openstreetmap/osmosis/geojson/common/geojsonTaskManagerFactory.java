...
/**
 * Extends the basic task manager factory functionality with geojson task specific common methods.
 *
 * @author Brett Henderson
 */
public abstract class geojsonTaskManagerFactory extends TaskManagerFactory {
